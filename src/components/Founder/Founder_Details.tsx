...
const FounderDetails = () => {
  return (
    <>
      <div className="SD_Main2 max-h-[787px] w-[1350px] gap-10 mx-auto justify-center grid grid-cols-2 mt-[60px]">
        <div className="Specialist_Img w-[100%] mt-[-60px] ml-10 pt-[60px] h-[787px] overflow-hidden">
          <LazyLoadImage
            width={600}
            src={Doctor}
            alt=""
        ...
        <div className="SD_ContentsF mt-20">
          <h1 className="SD_HelloF text-[32px] text-emerald-400">
            Hello, I am
          </h1>
          <p className="SD_NameF text-black flex font-bold text-[55px]">
            Major
          </p>
          <h1 className="SD_NameF text-black flex gap-3 font-bold text-[50px]">
            Dr.P.A.Subramanian{" "}
