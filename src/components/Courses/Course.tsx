...
//     <>
//       <div>
//         <div className="Course_Main mt-[60px] pt-[20px] bg-emerald-50 h-[76vh]">
...
//           {/* <div className="bg-emerald-50 h-[12vh] justify-center px-[40%] px-auto items-center">
//             <Button
//               onClick={() => togglePopup(course)}
//               className="bg-transparency w-[100%] hover:bg-emerald-400 text-[16px] font-medium border-2 border-emerald-400 rounded-md mt-[-270px] pt-2 pb-2 pl-5 pr-5"
//             >
//               Know More
//             </Button>
//             {isPopupVisible && (
