...
const AboutSpecialist = () => {
  ...
  return (
    <>
      <div
        id="About_Me"
        className="About_Me w-full h-[800px] bg-emerald-50 pt-[10px]"
      >
        <div className="SD_MainAS w-[1260px] gap-10 mx-auto justify-center flex">
          ...
          <div className="SD_Contents mt-24 ml-0">
            ...
            <p className="SD_Sub mt-10 text-[14px] max-w-[95%]">
              ...
              <br /> to new opportunities for impactful contributions.
              Establishing a low-cost medical college can be an incredibly
              rewarding endeavor for a retired doctor, driven by several
              compelling reasons:
            </p>
            ...
            <button
              onClick={onOpen}
              className="ClickHereM hidden absolute mt-[-92px] ml-[115px] overflow-hidden max-w-[210px] max-h-[180px]"
            >
              <iframe
                onClick={onOpen}
                      ...
                      <ModalBody className="popup-body mx-3 gap-10">
                        <div className="Popup_Container flex gap-4">
                          ...
                          <div className="Img_Model_Container flex flex-col h-[100%] bg-gray-100 p-3 rounded-xl gap-2">
                            ...
                            />
                            <p className="text-[14px] text-justify font-medium mt-2">
                              Major Dr.P.A.Subramanian AMC had also been a part
                              of Political gatherings int National Fort
                              gatherings under the guidance of Late former Chief
                              minister of Tamilnadu Thiru Karunanidhi (Kalaignar
                              )
                            </p>
                          </div>
                        </div>
          ...
          <div className="Specialist_Img w-[100%] grid grid-cols-2 gap-3 mt-[50px] mr-1 -ml-10 pt-[80px] h-[720px] overflow-hidden">
